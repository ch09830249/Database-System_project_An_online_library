<html>
	...
	<body background="images.jpg">
		<h1>書籍類別</h1>
				<h2><a href = "searchAI.php" class = "library">人工智慧</a></h2>
				<h2><a href = "searchbusiness.php" class = "library">商業用書</a></h2>
				<h2><a href = "searchNet.php" class = "library">網際網路</a></h2>
				<h2><a href = "searchtool.php" class = "library">電腦工具書</a></h2>
				<h2><a href = "searchprogdesign.php" class = "library">程式設計</a></h2>
				<h2><a href = "master.php" class = "library">考研用書</a></h2>
				<h3><a href = "index.php" class = "back">上一頁</a></h3>
	</body>
</html>